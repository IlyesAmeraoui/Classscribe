...
export function AppSidebar({ activeSection, onSectionChange, onProfileClick, user }: AppSidebarProps) {
  ...
  const userRole = user?.role === 'student' ? 'Student' : user?.role || 'User'
  const userAvatar = user?.profileImage || "/placeholder.svg"
